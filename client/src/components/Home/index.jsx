  ...
  return (
    <Layout bgColor={"bg-blue-50"}>
      ...
      <div className="w-7/8 md:w-3/5 md:p-8 pb-12 mx-auto gap-8 md:gap-20 flex flex-col">
        <img src={parliament} alt="Parliament" className="w-4/5 rounded-lg mx-auto" />
        <img src={lokSabha} alt="Lok Sabha" className="w-4/5 rounded-lg mx-auto" />
        <img src={rajyaSabha} alt="Rajya Sabha" className="w-4/ 5 rounded-lg mx-auto" />
        <img src={localBodies} alt="Local Bodies" className="w-4/5 rounded-lg mx-auto" />
      </div>
    </Layout>
  );
}
