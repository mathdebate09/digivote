...
function Footer() {
  return (
    <>
      <footer className="border-doubled border-t border-indigo-950 bg-transparent">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
              <div>
                ...
                <ul className="font-medium text-black-soft">
                  ...
                  <li>
                    <Link to="/forums" className="hover:underline">
                      Forums
                    </Link>
                  </li>
                </ul>
          ...
          <hr className="my-6 border-blue-800 sm:mx-auto lg:my-8" />
          <div className="sm:flex sm:items-center sm:justify-center">
            <span className="cursor-default text-sm text-black-soft sm:text-center">
              ...
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://github.com/mathdebate09/digivote/graphs/contributors"
                className="hover:underline"
              >
                semicolons; (team)
              </a>
